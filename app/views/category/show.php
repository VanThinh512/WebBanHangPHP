...
<div class="category-detail-container">
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="category-actions mt-4">
                <a href="<?php echo BASE_URL; ?>Category/edit/<?php echo $category->id; ?>" class="btn btn-warning mr-2">
    ...
    <div class="related-products mt-4">
        ...
        <a href="<?php echo BASE_URL; ?>Product?category=<?php echo $category->id; ?>" class="btn btn-primary mb-3">
